...
| [`mov #C` + `and`/`orr`/`eor`/`ands`](analyses.md#mov--andorreorands-foldable-to-bitmask-immediate) | `and`/`orr`/`eor`/`ands Rd, Rn, #C` |
...
| [`add #a` + `ldr [xt]`](analyses.md#add--ldr-foldable-to-immediate-offset-ldr) | `ldr [xn, #a]` |
